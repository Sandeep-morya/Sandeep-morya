			...
			<div className="about_description">
				<div className="texts">
					<div className="past">
						...
						complete my graduations in <span className='highlight'>Computer Science</span>.
					</div>
					...
					<div className="today">
						Fast-forward to today, i am a<span className='highlight'> Full Stack Web Developer</span>. I have
